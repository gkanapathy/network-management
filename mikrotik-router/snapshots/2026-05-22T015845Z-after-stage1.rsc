# 2026-05-21 18:58:46 by RouterOS 7.21.4
...
add default-route-distance=2 interface=sfp-sfpplus1
...
/ipv6 dhcp-client
add add-default-route=yes interface=ether2 pool-name=mb-pd request=\
    address,prefix
add add-default-route=yes default-route-distance=2 interface=sfp-sfpplus1 \
    pool-name=sonic-pd request=address,prefix
